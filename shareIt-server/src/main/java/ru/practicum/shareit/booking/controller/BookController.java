...
public class BookController {
    ...
    public ResponseBookingDto create(
            ...
            @RequestHeader("X-Sharer-User-Id") long userid) throws ObjectNotFoundException, ValidException {
    ...
    public Collection<ResponseBookingDto> findAllBookingByBooker(
        ...
        return bookingService.findAllBookingByBooker(userId, state, pageable);
    }
    ...
    public Collection<ResponseBookingDto> findAllBookingForOwnerByAllItems(
        ...
        //String stateResult = state.toUpperCase().replaceAll("\\s", "");
        Pageable pageable = PageRequest.of(from / size, size);
        return bookingService.findAllBookingForOwnerByAllItems(userId, state, pageable);
    }
}
